...
NLP pipeline for the Kaggle competition [Real or not? NLP with disaster tweets](https://www.kaggle.com/c/nlp-getting-started)

From the competition introduction:
